...
public class ScoreSpeakerSubwooferCmd extends SequentialCommandGroup {

  /** Creates a new ScoreAmpCmd. */
  public ScoreSpeakerSubwooferCmd(Shooter shooter) {

    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new TiltShooterToSetpointCmd(shooter, ScoringPresets.SPEAKER_SUBWOOFER_SHOOTER_TILT)
        .andThen(
